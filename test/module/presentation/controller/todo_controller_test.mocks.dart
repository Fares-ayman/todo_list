...
// in get_x_to_do_list/test/module/presentation/controller/todo_controller_test.dart.
...
class MockGetTodosUseCase extends _i1.Mock implements _i2.GetTodosUseCase {
  ...
  @override
  List<_i3.TodoModel> call() => (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveTodosUseCase extends _i1.Mock implements _i4.SaveTodosUseCase {
  MockSaveTodosUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  dynamic call({required List<_i3.TodoModel>? todos}) =>
